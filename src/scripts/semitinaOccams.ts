import {Filename, LogTarget, program, saveLog, scriptSettings, setupScriptAndIo, time} from "@sagittal/general"
import {computeBestCommaPerSemitinaZone, computeMetacommasAndBucketSortAndLogOccams} from "../semitinaOccams"

program
    .option("--complexity-only", "ignore error when choosing best commas per zone, essentially using a complexity measure rather than a full badness measure")
