...
const sortAndLogIntegerTinaOccamBuckets = (
    ...
    const tinaOccamBucketEntries = Object.entries(tinaOccamBuckets) as [
        unknown,
        Record<Name<Comma>, Occam>,
    ][] as [BucketName, Record<Name<Comma>, Occam>][]
...
export { sortAndLogIntegerTinaOccamBuckets }
