...
) as Min<ScaledVector<{ rational: false }>>
...
) as Max<ScaledVector<{ rational: false }>>
...
const TINA_COMMAS_EXTREMA: [
    Min<ScaledVector<{ rational: false }>>,
    Max<ScaledVector<{ rational: false }>>,
