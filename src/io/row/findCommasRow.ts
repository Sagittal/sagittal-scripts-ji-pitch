...
const computeFindCommasRow = (
    ...
    [
        ...computeNotatingCommasRow(commaAnalysis, maybeCommaClassId, maxVectorLength),
        ...(compute23FreeClassRow(commaAnalysis.two3FreeClassAnalysis) as Row as Row<{
            of: CommaAnalysis
        }>),
    ] as Row<{ of: CommaAnalysis }>

export { computeFindCommasRow }
