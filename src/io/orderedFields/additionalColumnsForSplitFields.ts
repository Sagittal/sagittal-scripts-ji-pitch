...
const computeAdditionalColumnCountForSplitPevField = (
    maxPevLength: Max<Count<Exponent<Prime>>> = 0 as Max<Count<Exponent<Prime>>>,
): Count<Column> =>
    add(maxPevLength, ONE) as Count<Column>
