    ...
    it("returns a row for each JI pitch being analyzed", (): void => {
        ...
        const expected =
            ("        \t      \t        \t \t  \t      \t       \t       \t       \t       \t       \t \t               \t       \t       \t       \t2,3-free\t2,3-free\t \t  \t   \t2,3-free\t2,3-free\t2,3-free" +
                ...
                NEWLINE +
                "class   \tname  \t       n\t/\td \t      \t  2    \t  3    \t  5    \t  7    \t 11    \t \tcents          \tslope  \tAAS    \tATE    \tlimit   \t       n\t/\td \t₂,₃\tCoPFR   \tSoPFR   \tN2D3P9  "
                    .underline +
                NEWLINE +
                "    /|\\ \t11M   \t      33\t/\t32\t     [\t -5    \t  1    \t  0    \t  0    \t  1    \t⟩\t        45.450¢\t -4.000\t  4.000\t  0    \t 11     \t      11\t/\t1 \t₂,₃\t  1     \t 11     \t  6.722 " +
                NEWLINE +
                "        \t25/49S\t      50\t/\t49\t     [\t  1    \t  0    \t  2    \t -2    \t       \t⟩\t        33.400¢\t -2.154\t  2.154\t  0    \t  7     \t      49\t/\t25\t₂,₃\t  4     \t 24     \t 26.466 " +
                NEWLINE) as Io
