...
describe("computeFindCommasOutput", (): void => {
    ...
    it("changes column widths so that each cell in a column has the same width", (): void => {
        ...
        const expected = ("" +
            ...
            "class   \tname  \t       n\t/\td \t      \t  2    \t  3    \t  5    \t  7    \t \tcents          \tslope  \tAAS    \tATE    \tlimit   \t       n\t/\td \t₂,₃\tCoPFR   \tSoPFR   \tN2D3P9  "
                .underline +
            NEWLINE +
            "    /|\\ \t11M   \t      33\t/\t32\t     [\t  0    \t  0    \t  1    \t       \t⟩\t        45.450¢\t -4.000\t  4.000\t  0    \t 11     \t      11\t/\t1 \t₂,₃\t  1     \t 11     \t  6.722 " +
            NEWLINE +
            "        \t25/49M\t      50\t/\t49\t     [\t  1    \t  0    \t  2    \t -2    \t⟩\t        33.400¢\t -2.154\t  2.154\t  0    \t  7     \t      49\t/\t25\t₂,₃\t  4     \t 24     \t 26.466 " +
            NEWLINE) as Io
    ...
    it("can format tables for sharing on the Sagittal forum", (): void => {
        ...
        const expected = ("" +
            ...
            "[table]" +
            NEWLINE +
            "[tr][th][/th][th][/th][th][/th][thr][/thr][th][/th][th][/th][th][/th][th][/th][thl][/thl][th][/th][th][/th][th][/th][th][/th][th]2,3-free[/th][th]2,3-free[/th][th]2,3-free[/th][th]2,3-free[/th][th]2,3-free[/th][/tr]" +
            NEWLINE +
            "[tr][th]comma[/th][th][/th][th][/th][th=6]vector[/th][th][/th][th]apotome[/th][th][/th][th][/th][th]prime[/th][th]class[/th][th]class[/th][th]class[/th][th]class[/th][/tr]" +
            NEWLINE +
            "[tr][th]class[/th][th]name[/th][th]quotient[/th][thr] [/thr][th]  2    [/th][th]  3    [/th][th]  5    [/th][th]  7    [/th][thl] [/thl][th]cents[/th][th]slope[/th][th]AAS[/th][th]ATE[/th][th]limit[/th][th]name[/th][th]CoPFR[/th][th]SoPFR[/th][th]N2D3P9[/th][/tr]" +
            NEWLINE +
            "[tr][td]:/|\\:[/td][td]11M[/td][td][latex]\\frac{33}{32}[/latex][/td][tdr][[/tdr][tdc]  0    [/tdc][tdc]  0    [/tdc][tdc]  1    [/tdc][tdc][/tdc][td]⟩[/td][td] 45.450¢[/td][td] -4.000[/td][td]  4.000[/td][td]  0    [/td][td] 11    [/td][td][latex]\\{11\\}_{\\scriptsize{2,3}}[/latex][/td][td]  1    [/td][td] 11    [/td][td]  6.722[/td][/tr]" +
            NEWLINE +
            "[tr][td][/td][td]25/49M[/td][td][latex]\\frac{50}{49}[/latex][/td][tdr][[/tdr][tdc]  1    [/tdc][tdc]  0    [/tdc][tdc]  2    [/tdc][tdc] -2    [/tdc][td]⟩[/td][td] 33.400¢[/td][td] -2.154[/td][td]  2.154[/td][td]  0    [/td][td]  7    [/td][td][latex]\\{\\frac{49}{25}\\}_{\\scriptsize{2,3}}[/latex][/td][td]  4    [/td][td] 24    [/td][td] 26.466[/td][/tr]" +
            NEWLINE +
            "[/table]" +
            NEWLINE) as Io
        expect(actual).toEqual(expected)
    ...
    it("can format tables for sharing on the Sagittal forum, but where the splitting of quotients and 2,3-free classes is preferred", (): void => {
        ...
        const expected = ("" +
            ...
            "[table]" +
            NEWLINE +
            "[tr][th][/th][th][/th][thr][/thr][th][/th][thl][/thl][thr][/thr][th][/th][th][/th][th][/th][th][/th][thl][/thl][th][/th][th][/th][th][/th][th][/th][th]2,3-free[/th][th=4]2,3-free[/th][th]2,3-free[/th][th]2,3-free[/th][th]2,3-free[/th][/tr]" +
            NEWLINE +
            "[tr][th]comma[/th][th][/th][th=3]quotient[/th][th=6]vector[/th][th][/th][th]apotome[/th][th][/th][th][/th][th]prime[/th][th=4]class[/th][th]class[/th][th]class[/th][th]class[/th][/tr]" +
            NEWLINE +
            "[tr][th]class[/th][th]name[/th][thr]n[/thr][th]/[/th][thl]d[/thl][thr] [/thr][th]  2    [/th][th]  3    [/th][th]  5    [/th][th]  7    [/th][thl] [/thl][th]cents[/th][th]slope[/th][th]AAS[/th][th]ATE[/th][th]limit[/th][thr]n[/thr][th]/[/th][thl]d[/thl][th][latex]_{\\scriptsize{2,3}}[/latex][/th][th]CoPFR[/th][th]SoPFR[/th][th]N2D3P9[/th][/tr]" +
            NEWLINE +
            "[tr][td]:/|\\:[/td][td]11M[/td][tdr]33[/tdr][tdc]/[/tdc][td]32[/td][tdr][[/tdr][tdc]  0    [/tdc][tdc]  0    [/tdc][tdc]  1    [/tdc][tdc][/tdc][td]⟩[/td][td] 45.450¢[/td][td] -4.000[/td][td]  4.000[/td][td]  0    [/td][td] 11    [/td][tdr]11[/tdr][tdc]/[/tdc][td]1[/td][td][latex]_{\\scriptsize{2,3}}[/latex][/td][td]  1    [/td][td] 11    [/td][td]  6.722[/td][/tr]" +
            NEWLINE +
            "[tr][td][/td][td]25/49M[/td][tdr]50[/tdr][tdc]/[/tdc][td]49[/td][tdr][[/tdr][tdc]  1    [/tdc][tdc]  0    [/tdc][tdc]  2    [/tdc][tdc] -2    [/tdc][td]⟩[/td][td] 33.400¢[/td][td] -2.154[/td][td]  2.154[/td][td]  0    [/td][td]  7    [/td][tdr]49[/tdr][tdc]/[/tdc][td]25[/td][td][latex]_{\\scriptsize{2,3}}[/latex][/td][td]  4    [/td][td] 24    [/td][td] 26.466[/td][/tr]" +
            NEWLINE +
            "[/table]" +
            NEWLINE) as Io
        expect(actual).toEqual(expected)
    ...
    it("can reorder fields", (): void => {
        ...
        const expected = ("" +
            ...
            "      \t       \t       \t       \t       \t \t2,3-free\t \t  \t   \t        \t \t  \t               " +
            NEWLINE +
            "vector\t       \t       \t       \t       \t \t   class\t \t  \t   \tquotient\t \t  \t               " +
            NEWLINE +
            "      \t  2    \t  3    \t  5    \t  7    \t \t       n\t/\td \t₂,₃\t       n\t/\td \tcents          "
                .underline +
            NEWLINE +
            "     [\t  0    \t  0    \t  1    \t       \t⟩\t      11\t/\t1 \t₂,₃\t      33\t/\t32\t        45.450¢" +
            NEWLINE +
            "     [\t  1    \t  0    \t  2    \t -2    \t⟩\t      49\t/\t25\t₂,₃\t      50\t/\t49\t        33.400¢" +
            NEWLINE) as Io
        expect(actual).toEqual(expected)
    })
