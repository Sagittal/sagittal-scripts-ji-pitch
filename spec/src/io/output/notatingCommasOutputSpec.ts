...
describe("computeNotatingCommasOutput", (): void => {
    ...
    it("can format the notating commas for the terminal", (): void => {
        ...
        const expected = ("   --- notating commas ---" +
            NEWLINE +
            "" +
            NEWLINE +
            "comma   \t      \tquotient\t \t  \tvector\t       \t       \t       \t       \t \t               \tapotome\t       \t       " +
            NEWLINE +
            "class   \tname  \t       n\t/\td \t      \t  2    \t  3    \t  5    \t  7    \t \tcents          \tslope  \tAAS    \tATE    "
                .underline +
            NEWLINE +
            "    /|\\ \t11M   \t      33\t/\t32\t     [\t  0    \t  0    \t  1    \t       \t⟩\t        45.450¢\t -4.000\t  4.000\t  0    " +
            NEWLINE +
            "        \t25/49M\t      50\t/\t49\t     [\t  1    \t  0    \t  2    \t -2    \t⟩\t        33.400¢\t -2.154\t  2.154\t  0    " +
            NEWLINE) as Io
    ...
    it("can format the notating commas for the forum", (): void => {
        ...
        const expected = ("   --- notating commas ---" +
            ...
            "[table]" +
            NEWLINE +
            "[tr][th]comma[/th][th][/th][th][/th][th=6]vector[/th][th][/th][th]apotome[/th][th][/th][th][/th][/tr]" +
            NEWLINE +
            "[tr][th]class[/th][th]name[/th][th]quotient[/th][thr] [/thr][th]  2    [/th][th]  3    [/th][th]  5    [/th][th]  7    [/th][thl] [/thl][th]cents[/th][th]slope[/th][th]AAS[/th][th]ATE[/th][/tr]" +
            NEWLINE +
            "[tr][td]:/|\\:[/td][td]11M[/td][td][latex]\\frac{33}{32}[/latex][/td][tdr][[/tdr][tdc]  0    [/tdc][tdc]  0    [/tdc][tdc]  1    [/tdc][tdc][/tdc][td]⟩[/td][td] 45.450¢[/td][td] -4.000[/td][td]  4.000[/td][td]  0    [/td][/tr]" +
            NEWLINE +
            "[tr][td][/td][td]25/49M[/td][td][latex]\\frac{50}{49}[/latex][/td][tdr][[/tdr][tdc]  1    [/tdc][tdc]  0    [/tdc][tdc]  2    [/tdc][tdc] -2    [/tdc][td]⟩[/td][td] 33.400¢[/td][td] -2.154[/td][td]  2.154[/td][td]  0    [/td][/tr]" +
            NEWLINE +
            "[/table]" +
            NEWLINE) as Io
        expect(actual).toBe(expected)
    ...
    it("can reorder fields", (): void => {
        ...
        const expected = ("   --- notating commas ---" +
            ...
            "vector\t       \t       \t       \t       \t \t       \tquotient\t \t  \t               " +
            NEWLINE +
            "      \t  2    \t  3    \t  5    \t  7    \t \tATE    \t       n\t/\td \tcents          "
                .underline +
            NEWLINE +
            "     [\t  0    \t  0    \t  1    \t       \t⟩\t  0    \t      33\t/\t32\t        45.450¢" +
            NEWLINE +
            "     [\t  1    \t  0    \t  2    \t -2    \t⟩\t  0    \t      50\t/\t49\t        33.400¢" +
            NEWLINE) as Io
        expect(actual).toBe(expected)
    })
